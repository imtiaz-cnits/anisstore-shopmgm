...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid px-0">
            ...
            <!-- Page Header Bar -->
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-4 pb-2 border-bottom gap-3">
                <div>
                    <h1 class="h3 fw-bold text-dark mb-1 d-flex align-items-center gap-2">
                        <i class="fa-solid fa-arrow-rotate-left text-success"></i> Return Management (পণ্য রিটার্ন)
                    </h1>
                    <p class="text-muted mb-0 small">মেসার্স আনিস ষ্টোর - সেলস (বিক্রি) ও পারচেজ (ক্রয়) রিটার্ন ব্যবস্থাপনা</p>
                </div>
                <div class="w-100 w-sm-auto">
                    <button id="mainNewReturnBtn" onclick="triggerNewReturnModal()" class="btn btn-success fw-bold rounded-pill px-4 shadow-sm w-100 w-sm-auto py-2" style="background: linear-gradient(135deg, #15803d 0%, #16a34a 100%); border: none;">
            ...
            <div class="d-flex align-items-center gap-2 mb-4 w-100">
                <button id="tabSalesReturnBtn" onclick="switchReturnTab('sales')" class="btn btn-success fw-bold px-3 px-sm-4 py-2 rounded-pill shadow-sm return-tab-btn">
                    <i class="fa-solid fa-cart-shopping me-1"></i> Sales Return
                </button>
                <button id="tabPurchaseReturnBtn" onclick="switchReturnTab('purchase')" class="btn btn-outline-secondary fw-bold px-3 px-sm-4 py-2 rounded-pill return-tab-btn">
                    <i class="fa-solid fa-truck-ramp-box me-1"></i> Purchase Return
                </button>
            </div>
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table align-middle table-hover mb-0 table-compact-mobile" id="printTable">
                            <thead class="bg-light">
                                <tr class="text-uppercase small fw-bold text-muted">
                                    <th class="ps-3 ps-sm-4" style="width: 50px;">SL</th>
                                    <th style="width: 120px;">Return Date</th>
                                    <th id="thInvoiceNo" style="width: 130px;">Invoice No</th>
                                    <th id="thPartyName">Customer Name</th>
                                    <th>Returned Product</th>
                                    <th class="text-center" style="width: 90px;">Qty</th>
                                    <th class="text-end pe-3 pe-sm-4" style="width: 130px;">Refund Amount</th>
                                </tr>
                            </thead>
                            <tbody id="tableList">
