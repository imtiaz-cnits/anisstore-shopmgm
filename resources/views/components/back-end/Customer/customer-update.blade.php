            ...
            <div id="popup-modal">
                <form onsubmit="return Update(event)">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-row">
                                <input type="tel" inputmode="tel" placeholder="Enter Customer Number *" id="UpdateCustomerNumber" required oninput="if(typeof enforceBanglaNumberInput==='function'){enforceBanglaNumberInput(this, false);}else{this.value=this.value.replace(/[^0-9+০-৯]/g,'');}" />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-row">
                                <input type="text" inputmode="numeric" placeholder="Enter Customer NID" id="UpdateCustomerNid" oninput="if(typeof enforceBanglaNumberInput==='function'){enforceBanglaNumberInput(this, false);}else{this.value=this.value.replace(/[^0-9০-৯]/g,'');}" />
                            </div>
                        </div>
                        <div class="col-lg-6 mb-3">
                            <div class="form-row">
                                <input type="text" inputmode="decimal" placeholder="Enter Previous Due Amount" id="UpdateCustomerPreviousDueAmount" oninput="if(typeof enforceBanglaNumberInput==='function'){enforceBanglaNumberInput(this, true);}else{this.value=this.value.replace(/[^0-9.০-৯]/g,'');}" />
                            </div>
                        </div>
                        <div class="col-lg-6 mb-3">
                            <div class="form-row">
