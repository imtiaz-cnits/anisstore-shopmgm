    ...
    <script>
        ...
        function renderLiveDropdown(containerId, cleanTerm) {
            ...
            if (!cleanTerm || cleanTerm.length === 0 || !rawProductData || rawProductData.length === 0) {
            ...
            let matches = rawProductData.filter(item => {
            ...
            if (matches.length === 0) {
                dropdown.html('<div class="p-3 text-center text-muted small"><i class="fa-solid fa-circle-exclamation me-1"></i>কোনো প্রোডাক্ট পাওয়া যায়নি</div>').removeClass("d-none");
                return;
            }
            ...
            matches.forEach(item => {
                ...
                const stockDisplay = qtyVal <= 0 ? `<span class="badge bg-danger-subtle text-danger" style="font-size: 10px;">স্টক শেষ</span>` : `<span class="text-muted small" style="font-size: 10.5px;">স্টক: ${qtyVal}</span>`;
