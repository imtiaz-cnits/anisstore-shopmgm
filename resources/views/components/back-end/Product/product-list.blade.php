    ...
    <div class="main-content">
        <div class="page-content">
            ...
            <div class="data-table">
                <!-- Smart Product Metric Summary Cards Bar -->
                <div class="row g-2 mb-3">
                    <div class="col-6 col-sm-4 col-md">
                        <div class="card border-0 shadow-sm rounded-3 py-2 px-3 bg-white border-start border-4 border-primary h-100">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="text-muted d-block small fw-bold" style="font-size: 10px; text-transform: uppercase;">মোট প্রোডাক্ট</span>
                                    <h4 id="summaryTotalProducts" class="fw-extrabold text-primary mb-0" style="font-size: 17px;">0</h4>
                                </div>
                    ...
                    <div class="col-6 col-sm-4 col-md">
                        <div class="card border-0 shadow-sm rounded-3 py-2 px-3 bg-white border-start border-4 border-danger h-100" style="background-color: #fef2f2 !important;">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="text-danger d-block small fw-extrabold" style="font-size: 10px; text-transform: uppercase;">স্টক আউট (≤০)</span>
                                    <h4 id="summaryOutOfStock" class="fw-extrabold text-danger mb-0" style="font-size: 17px;">0</h4>
                                </div>
                                <div class="bg-danger text-white rounded-circle p-2 d-flex align-items-center justify-content-center shadow-sm" style="width: 36px; height: 36px;">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="button-wrapper mb-3">
                            <!-- Prominent Wide Search Input Bar -->
                            <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                                <div class="position-relative search-input-wrapper flex-grow-1" style="max-width: 650px; width: 100%;">
                                    <input type="text" id="searchInput" class="form-control shadow-sm rounded-3 border border-2 border-success-subtle px-3 py-2 fw-semibold pe-5"
                                        placeholder="যেকোনো পণ্য, কোড, দাম বা ব্র্যান্ড টাইপ করে খুঁজুন..." onfocus="this.select()"
                                        style="height: 48px; font-size: 15px; background: #ffffff;" />
                                    <button type="button" id="clearSearchBtn" class="btn p-0 border-0 position-absolute end-0 top-50 translate-middle-y me-3 text-muted d-none" style="z-index: 5;" onclick="clearSearchField()" title="Clear Search">
                                        <i class="fa-solid fa-circle-xmark fs-4 text-secondary"></i>
                                    </button>
                                </div>
                                <div class="entries-page ms-auto d-none d-lg-flex align-items-center gap-1">
                            ...
                            <div class="button-item">
                                <button id="openModalBtns" type="button" class="create-invoice" onclick="openPosAddProductModal()">
                                    + Add Product
                                </button>
            ...
            pageItems.forEach(function (item, idx) {
                ...
                let mobileCard = `
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="product-mobile-card card border shadow-sm rounded-4 p-3 position-relative bg-white h-100">
                            ...
                            <div class="row g-2 bg-light p-2 rounded-3 my-2 text-center align-items-center" style="border: 1px solid #f1f5f9;">
                                <div class="col-4 border-end">
                                    ...
                                    <span class="fw-bold text-dark" style="font-size: 12px;">${engToBanglaNum(item.quantity)}${unitName ? ' ' + unitName : ''}</span>
                                </div>
                                <div class="col-4 border-end">
                                    <span class="text-muted d-block small fw-bold" style="font-size: 9px; text-transform: uppercase;">ক্রয়মূল্য</span>
                                    <span class="fw-bold text-danger" style="font-size: 12px;">৳ ${engToBanglaNum(parseFloat(item.cost_price).toFixed(2))}</span>
                                </div>
                                <div class="col-4">
                                    <span class="text-muted d-block small fw-bold" style="font-size: 9px; text-transform: uppercase;">বিক্রয়মূল্য</span>
                                    <span class="fw-bold text-success" style="font-size: 12px;">৳ ${engToBanglaNum(parseFloat(item.sell_price).toFixed(2))}</span>
                                </div>
                            </div>

                            <div class="d-flex align-items-center justify-content-between pt-2 mt-auto border-top">
                                <div class="text-muted small" style="font-size: 11px;">
                                    মোট ক্রয়: <span class="fw-bold text-dark">৳ ${engToBanglaNum((parseFloat(item.cost_price) * parseInt(item.quantity)).toFixed(2))}</span>
                                </div>
