                    ...
                    <div class="col-12 col-md-6 align-self-start mb-0">
                        <div class="product-user-card card border shadow-sm p-3 position-relative mb-0 bg-white" style="border-color: #E2E8F0 !important; border-radius: 6px !important;">
                            <div class="d-flex align-items-center justify-content-between gap-3">
                                ...
                                <img src="${imgPath}" onerror="this.src='${defaultImg}'" alt="${item.product_name}" class="product-circle-img" style="width: 50px; height: 50px; border-radius: 50% !important; object-fit: cover; border: 1.5px solid #E5D5F7; flex-shrink: 0;" />
