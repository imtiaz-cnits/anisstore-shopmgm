...
@section('title', 'দৈনিক প্রাপ্তি ও প্রদান রিপোর্ট তালিকা - মেসার্স আনিস ষ্টোর')
@section('content')
...
<style>
    ...
    #receiptPaymentDetailsModal .modal-dialog {
        transition: transform 0.3s cubic-bezier(0.16, 1, 0.3, 1) !important;
    }
    @media (max-width: 991.98px) {
        #customDateRangeModal,
        #receiptPaymentDetailsModal {
            padding: 10px !important;
        ...
        #receiptPaymentDetailsModal .modal-content {
...
<div class="main-content">
    <div class="page-content" style="padding: 0px !important;">
                ...
                <div class="card-body p-3 p-lg-4">
                    ...
                    <div class="invoice-card-header mb-3 pb-2 border-bottom d-flex align-items-center justify-content-between no-print">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="invoice-main-heading m-0 p-0 fw-bold">দৈনিক প্রাপ্তি ও প্রদান রিপোর্ট তালিকা</h4>
                            </div>
                        </div>
                    ...
                    <div id="mobileSearchWrap" class="mb-3 d-none position-relative no-print">
                        <div class="d-flex align-items-center gap-2 mb-0">
                            <div class="position-relative flex-grow-1 mb-0">
                                <input type="text" id="mobileSearchInput" class="form-control invoice-search-input mb-0" placeholder="পার্টি বা খরচের খাত খুঁজুন..." autocomplete="off" />
                    ...
                    <div class="invoice-date-section mb-3 d-none d-lg-block no-print">
                        ...
                        <!-- Search Button -->
                        <button type="button" class="invoice-search-submit-btn w-100 fw-bold d-flex align-items-center justify-content-center gap-2" onclick="fetchReceiptPaymentReport()">
                            <i class="fa-solid fa-magnifying-glass"></i>
                    ...
                    <div class="invoice-search-box-wrap mb-3 position-relative d-none d-lg-block no-print">
                        <input type="text" id="searchInput" class="form-control invoice-search-input" placeholder="পার্টি, বিবরণ বা খরচের খাত দিয়ে খুঁজুন..." autocomplete="off" />
                    ...
                    <div class="invoice-toolbar-section mb-3 d-none d-lg-flex flex-column gap-3 no-print">
                        ...
                        <div class="toolbar-row-2 w-100" style="display: grid !important; grid-template-columns: 1fr 1fr !important; gap: 10px !important;">
                            <button type="button" id="pdfBtn" onclick="exportReceiptPaymentPDF()" class="toolbar-control-btn w-100 d-flex align-items-center justify-content-center px-3" title="PDF ডাউনলোড করুন">
                    ...
                    <div class="invoice-top-summary-strip mb-3 p-2.5 px-3 bg-white" style="border-radius: 6px !important; border: none !important; box-shadow: 0 4px 18px rgba(140, 86, 212, 0.08), 0 1px 3px rgba(0, 0, 0, 0.04) !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex flex-column text-start ps-1 flex-grow-1">
                                <span class="text-muted small fw-medium" style="font-size: 12px;">মোট কালেকশন</span>
                                <span class="fw-bold text-success" id="topSummaryTotalCount" style="font-size: 15.5px; font-family: 'Noto Sans Bengali', 'Poppins', sans-serif;">৳ ০.০০</span>
                            </div>
                            ...
                            <div class="d-flex flex-column text-end pe-1 flex-grow-1">
                                <span class="text-muted small fw-medium" style="font-size: 12px;">সমাপনী ক্যাশ (Closing)</span>
                    ...
                    <div class="row g-2 g-md-3 mb-3 no-print">
                        <div class="col-6 col-md-3">
                            <div class="ledger-metric-card h-100" style="background: #f0fdf4; border-left: 4px solid #16a34a !important;">
                                <span class="text-muted small fw-bold d-block mb-1" style="font-size: 11px;">প্রারম্ভিক ক্যাশ (B/D)</span>
                                <h4 id="summaryOpeningBalance" class="fw-bold text-success mb-0" style="font-size: 15px;">৳ ০.০০</h4>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="ledger-metric-card h-100" style="background: #f0f9ff; border-left: 4px solid #0284c7 !important;">
                                <span class="text-muted small fw-bold d-block mb-1" style="font-size: 11px;">বিক্রয় কালেকশন</span>
                                <h4 id="summarySalesCollection" class="fw-bold text-primary mb-0" style="font-size: 15px;">৳ ০.০০</h4>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="ledger-metric-card h-100" style="background: #fef2f2; border-left: 4px solid #ef4444 !important;">
                                <span class="text-muted small fw-bold d-block mb-1" style="font-size: 11px;">মোট প্রদান ও খরচ</span>
                                <h4 id="summaryTotalOut" class="fw-bold text-danger mb-0" style="font-size: 15px;">৳ ০.০০</h4>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="ledger-metric-card h-100" style="background: #f5f3ff; border-left: 4px solid #8C56D4 !important;">
                                <span class="text-muted small fw-bold d-block mb-1" style="font-size: 11px;">সমাপনী ক্যাশ (Closing)</span>
                                <h4 id="summaryClosingBalance" class="fw-bold mb-0" style="font-size: 15px; color: #8C56D4;">৳ ০.০০</h4>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="printTable" class="table table-bordered table-hover align-middle mb-0">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-start">বিবরণ / পার্টি / খাত</th>
                                        <th class="text-center" style="width: 140px;">লেনদেনের ধরন</th>
                                        <th class="text-end text-success" style="width: 150px;">প্রাপ্তি / জমা</th>
                                        <th class="text-end text-danger" style="width: 150px;">প্রদান / খরচ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr><td colspan="5" class="text-center py-4 text-muted">ডাটা লোড হচ্ছে...</td></tr>
                                </tbody>
                                <tfoot class="table-light fw-bold border-top">
                                    <tr>
                                        <td colspan="3" class="text-end ps-4">সর্বমোট:</td>
                                        <td class="text-end text-success" id="tfootTotalIn">৳ ০.০০</td>
                                        <td class="text-end text-danger" id="tfootTotalOut">৳ ০.০০</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
        ...
        <!-- Receipt & Payment Details Modal (Sticky header & footer, scrollable body) -->
        <div class="modal fade" id="receiptPaymentDetailsModal" tabindex="-1" aria-labelledby="receiptPaymentDetailsModalLabel" aria-hidden="true" style="z-index: 10600;">
                ...
                <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
                    <div class="modal-header-purple d-flex align-items-center justify-content-between flex-shrink-0">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h6 class="modal-title fw-bold m-0 text-white" id="receiptPaymentDetailsModalLabel" style="font-size: 15px;">প্রাপ্তি ও প্রদানের বিস্তারিত বিবরণ</h6>
                        </div>
                        <button type="button" class="btn-close-red" data-bs-dismiss="modal" aria-label="Close" title="বন্ধ করুন">
                            <i class="fa-solid fa-xmark"></i>
                        </button>
                    </div>
                    <div class="modal-body p-3 overflow-y-auto" style="max-height: calc(85vh - 120px);" id="receiptPaymentDetailsBody">
                        <!-- Filled dynamically -->
                    </div>
                    <div class="modal-sticky-footer d-flex align-items-center justify-content-between gap-2 flex-shrink-0">
                        ...
                        <button type="button" id="receiptPaymentDetailModalPrintBtn" class="btn text-white fw-bold px-3 py-2 d-inline-flex align-items-center gap-1.5" style="height: 38px; border-radius: 6px; background: linear-gradient(135deg, #8C56D4 0%, #793FC5 100%); font-size: 13px; border: none;">
...
<script>
    ...
    function renderLiveDropdown(containerId, clean) {
        ...
        if (!clean || clean.length === 0 || !rawEntries || rawEntries.length === 0) {
            dropdown.addClass("d-none").empty();
            return;
        }

        let matches = rawEntries.filter(item => {
            let title = String(item.particulars || "").toLowerCase();
        ...
        matches.forEach(item => {
            const safeSearch = (item.particulars || '').replace(/'/g, "\\'");
            const isReceipt = item.inflow > 0;
            html += `
                <div class="search-live-item" onclick="selectSearchItem('${safeSearch}')">
                    <div class="d-flex align-items-center gap-2 overflow-hidden">
                        ...
                        <div class="overflow-hidden">
                            <span class="fw-bold text-dark d-block text-truncate" style="font-size: 13px;">${item.particulars || ''}</span>
                            <span class="text-muted small" style="font-size: 11px;">${item.category || ''}</span>
                        </div>
                    </div>
                    <div class="text-end flex-shrink-0 ms-2">
                        <div class="fw-bold ${isReceipt ? 'text-success' : 'text-danger'}" style="font-size: 12.5px;">৳ ${formatMoneyBn(isReceipt ? item.inflow : item.outflow)}</div>
                    </div>
                </div>
            `;
        });
    ...
    function applyClientFilter(term) {
        ...
        if (!clean) {
            ...
            filteredEntries = rawEntries.filter(item => {
                let title = String(item.particulars || "").toLowerCase();
                let cat = String(item.category || "").toLowerCase();
                return title.includes(clean) || cat.includes(clean);
            });
    ...
    async function fetchReceiptPaymentReport() {
        ...
        try {
            ...
            const res = await axios.get("/api/daily-receipt-payment-report", {
                ...HeaderToken(),
                params: {
            ...
            let openingBalance = parseFloat(res.data.OpeningBalance || 0);
            let totalCollectionSales = parseFloat(res.data.CollectionFromSales || 0);
            ...
            rawEntries = [];
            const currentPeriodDate = sVal || $("#startDate").val();

            // 1. Opening Balance entry
            rawEntries.push({
                date: currentPeriodDate,
                particulars: 'প্রারম্ভিক ক্যাশ ব্যালেন্স (Opening B/D)',
                category: 'প্রারম্ভিক ক্যাশ',
                inflow: openingBalance,
                outflow: 0
            });

            // 2. Collection from Sales entry
            rawEntries.push({
                date: currentPeriodDate,
                particulars: 'বিক্রয় থেকে মোট কালেকশন ও বকেয়া আদায়',
                category: 'বিক্রয় কালেকশন',
                inflow: totalCollectionSales,
                outflow: 0
            });
            ...
            supplierPayments.forEach(sup => {
                ...
                totalSupplierAmount += amt;
                rawEntries.push({
                    date: currentPeriodDate,
                    particulars: sup.supplier_name || 'সাপ্লায়ার পেমেন্ট',
                    category: 'সাপ্লায়ার প্রদান',
                    inflow: 0,
                    outflow: amt
                });
            });
            ...
            expenses.forEach(exp => {
                ...
                rawEntries.push({
                    date: currentPeriodDate,
                    particulars: exp.type_name || 'দৈনিক খরচ',
                    category: 'খরচের বিবরণ',
                    inflow: 0,
                    outflow: amt
                });
            });

            const totalOutflow = totalSupplierAmount + totalExpenseAmount;
            const netCashInPeriod = totalCollectionSales - totalOutflow;
            const closingBalance = openingBalance + netCashInPeriod;

            $("#summaryOpeningBalance").text('৳ ' + formatMoneyBn(openingBalance));
            $("#summarySalesCollection").text('৳ ' + formatMoneyBn(totalCollectionSales));
            $("#summaryTotalOut").text('৳ ' + formatMoneyBn(totalOutflow));
            $("#summaryClosingBalance").text('৳ ' + formatMoneyBn(closingBalance));

            $("#topSummaryTotalCount").text('৳ ' + formatMoneyBn(totalCollectionSales));
            $("#topSummaryTotalAmount").text('৳ ' + formatMoneyBn(closingBalance));

            let totalInSum = openingBalance + totalCollectionSales;
            $("#tfootTotalIn").text('৳ ' + formatMoneyBn(totalInSum));
            $("#tfootTotalOut").text('৳ ' + formatMoneyBn(totalOutflow));
            ...
            if (typeof hideLoader === "function") hideLoader();
            console.error('Error fetching receipt payment report:', e);
    ...
    function renderPaginatedView() {
        ...
        if (pageItems.length === 0) {
            tbody.html('<tr><td colspan="5" class="text-center py-4 text-muted fw-bold">কোনো এন্ট্রি পাওয়া যায়নি</td></tr>');
            mobileContainer.html('<div class="col-12 p-4 text-center text-muted fw-bold invoice-mobile-card shadow-sm" style="border-radius: 6px !important;">কোনো এন্ট্রি পাওয়া যায়নি</div>');
        } else {
            pageItems.forEach((item, idx) => {
                const realIndex = startIndex + idx;
                const isReceipt = item.inflow > 0;
                const badgeClass = isReceipt ? 'bg-success-subtle text-success border border-success-subtle' : 'bg-danger-subtle text-danger border border-danger-subtle';
                const typeLabel = isReceipt ? 'প্রাপ্তি/জমা' : 'প্রদান/খরচ';

                // Desktop Row
                const row = `
                    <tr>
                        <td class="text-center fw-semibold text-muted">${engToBanglaNum(realIndex + 1)}</td>
                        <td class="fw-bold text-dark">${item.particulars}</td>
                        <td class="text-center">
                            <span class="badge ${badgeClass} px-2.5 py-1 fw-bold fs-7">${item.category}</span>
                        </td>
                ...
                // Mobile & Tablet Card
                const dateObj = formatCardDate(item.date || $("#startDate").val());
                const mobileCard = `
                            ...
                            <div class="d-flex align-items-stretch" style="width: 100%; min-width: 0; overflow: hidden;">
                                ...
                                <div class="card-content-wrap d-flex flex-column justify-content-between">
                                    <div class="card-title-row mb-0.5">
                                        <div class="fw-bold text-dark card-title-text" style="font-size: 14px;" title="${item.particulars}">
                                            ${item.particulars}
                                        </div>
                                        <div class="card-badge-pill">
                                            <span class="badge ${badgeClass} px-2 py-0.5 fw-bold" style="font-size: 11px; border-radius: 6px;" title="${item.category}">
                                                ${item.category}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-title-row mb-1">
                                        <div class="card-title-text" style="font-size: 11.5px; color: #64748b;">
                                            <span>ধরন: ${typeLabel}</span>
                                        </div>
                                    </div>

                                    <div class="d-flex align-items-center justify-content-between gap-2" style="width: 100%; min-width: 0; overflow: hidden;">
                                        <div class="fw-bold ${isReceipt ? 'text-success' : 'text-danger'} text-truncate" style="font-size: 14px; min-width: 0; flex: 1 1 0%;">
                                            ${isReceipt ? '+' : '-'} ৳ ${formatMoneyBn(isReceipt ? item.inflow : item.outflow)}
                                        </div>
                                        <div class="d-flex align-items-center flex-shrink-0">
                                            <span class="badge bg-light text-dark border" style="font-size: 11px;">${typeLabel}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    function exportReceiptPaymentPDF() {
        const element = document.getElementById('printableArea');
        const opt = {
            margin: 10,
            filename: 'daily-receipt-payment-report.pdf',
    ...
    function printSingleRecord(index) {
        ...
        const isReceipt = item.inflow > 0;
        const typeLabel = isReceipt ? 'প্রাপ্তি / জমা' : 'প্রদান / খরচ';
        const amount = isReceipt ? item.inflow : item.outflow;
        ...
        printWindow.document.write(`
            ...
            <head>
                <meta charset="utf-8">
                <title>প্রাপ্তি ও প্রদান ভাউচার</title>
                <style>
                    @page {
                        size: auto;
            ...
            <body>
                <div class="slip-container">
                    <div class="shop-header">
                        ...
                        <div class="slip-title">দৈনিক প্রাপ্তি ও প্রদান ভাউচার</div>
                    </div>
                    <div class="slip-row">
                    ...
                    <div class="slip-row">
                        <span class="slip-label">বিবরণ / খাত:</span>
                        <span class="slip-val">${item.particulars || '-'}</span>
                    </div>
                    <div class="slip-row">
                        <span class="slip-label">ক্যাটেগরি:</span>
                        <span class="slip-val">${item.category || '-'}</span>
                    </div>
                    <div class="slip-row">
                        <span class="slip-label">লেনদেনের ধরন:</span>
                        <span class="slip-val" style="color: ${isReceipt ? '#16a34a' : '#dc2626'}; font-weight: bold;">${typeLabel}</span>
                    </div>
                    <div class="amount-box">
                        মোট টাকা: ৳ ${formatMoneyBn(amount)}
                    </div>
                    <div class="signature-row">
                        <div class="sig-line">গ্রহীতা / পেয়ার</div>
    ...
    function openRecordDetailsModal(index) {
        ...
        const isReceipt = item.inflow > 0;
        const typeLabel = isReceipt ? 'প্রাপ্তি / জমা' : 'প্রদান / খরচ';
        const badgeClass = isReceipt ? 'text-success bg-success-subtle border-success-subtle' : 'text-danger bg-danger-subtle border-danger-subtle';
        const amount = isReceipt ? item.inflow : item.outflow;
        ...
        let html = `
            <div class="modal-top-amount-box text-center p-3 mb-3">
                ...
                <h3 class="fw-bold m-0 ${isReceipt ? 'text-success' : 'text-danger'}" style="font-size: 22px;">
                    ${isReceipt ? '+' : '-'} ৳ ${formatMoneyBn(amount)}
                </h3>
            </div>
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <div class="detail-info-item detail-item-info p-2.5 rounded-3 d-flex justify-content-between align-items-center">
                    <span class="detail-info-label small">বিবরণ / খাত</span>
                    <span class="detail-info-val fw-bold text-dark">${item.particulars || '-'}</span>
                </div>
                <div class="detail-info-item detail-item-info p-2.5 rounded-3 d-flex justify-content-between align-items-center">
                ...
                <div class="detail-info-item detail-item-info p-2.5 rounded-3 d-flex justify-content-between align-items-center">
                    <span class="detail-info-label small">প্রাপ্তি / জমা</span>
                    <span class="detail-info-val fw-bold text-success">${item.inflow > 0 ? '৳ ' + formatMoneyBn(item.inflow) : '-'}</span>
                </div>
                <div class="detail-info-item detail-item-info p-2.5 rounded-3 d-flex justify-content-between align-items-center">
                    <span class="detail-info-label small">প্রদান / খরচ</span>
                    <span class="detail-info-val fw-bold text-danger">${item.outflow > 0 ? '৳ ' + formatMoneyBn(item.outflow) : '-'}</span>
                </div>
            </div>
        `;

        $("#receiptPaymentDetailsBody").html(html);
        $("#receiptPaymentDetailModalPrintBtn").attr("onclick", `printSingleRecord(${index})`);

        const modal = new bootstrap.Modal(document.getElementById('receiptPaymentDetailsModal'));
        modal.show();
    }
    ...
    function printFullReportTable() {
        ...
        if (filteredEntries.length === 0) {
            rowsHtml = `<tr><td colspan="5" style="text-align: center; padding: 20px; color: #64748b;">কোনো এন্ট্রি পাওয়া যায়নি</td></tr>`;
        } else {
            filteredEntries.forEach((item, idx) => {
                totalInflow += (item.inflow || 0);
                totalOutflow += (item.outflow || 0);
                rowsHtml += `
                    <tr>
        ...
        printWindow.document.write(`
            ...
            <html lang="bn">
            <head>
                <title>দৈনিক প্রাপ্তি ও প্রদান রিপোর্ট তালিকা - মেসার্স আনিস ষ্টোর</title>
                <meta charset="utf-8">
                <style>
                    @page {
                        size: auto;
            ...
            <body>
                <div class="header-wrap">
                    ...
                    <div>
                        <div class="report-pill-badge">দৈনিক প্রাপ্তি ও প্রদান রিপোর্ট তালিকা</div>
                ...
                <div class="summary-box">
                    <div class="summary-box-left">
                        ...
                        <div><strong>মোট লেনদেন সংখ্যা:</strong> ${engToBanglaNum(filteredEntries.length)} টি</div>
                    </div>
                    <div class="summary-box-right">
                        <div><strong>মোট প্রাপ্তি (জমা):</strong> <span style="color:#16a34a; font-weight:700;">৳ ${formatMoneyBn(totalInflow)}</span></div>
                        <div><strong>মোট প্রদান (খরচ):</strong> <span style="color:#dc2626; font-weight:700;">৳ ${formatMoneyBn(totalOutflow)}</span></div>
                    </div>
                </div>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: left;">বিবরণ / খাত</th>
                            <th style="width: 140px; text-align: center;">ক্যাটাগরি</th>
                            <th style="width: 130px; text-align: right;">প্রাপ্তি (জমা)</th>
                            <th style="width: 130px; text-align: right;">প্রদান (খরচ)</th>
                        </tr>
                    </thead>
                    <tbody>
                        ${rowsHtml}
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3" style="text-align: right; padding-right: 12px;">সর্বমোট:</td>
                            <td style="text-align: right; color: #16a34a;">৳ ${formatMoneyBn(totalInflow)}</td>
                            <td style="text-align: right; color: #dc2626;">৳ ${formatMoneyBn(totalOutflow)}</td>
                        </tr>
                    </tfoot>
                </table>
