        ...
        <div class="page-content">
            ...
            <div class="bredcam">
                <div class="bredcam-title">
                    <h1>Out of Stock Product History</h1>
                </div>
            </div>
                            ...
                            <table id="printTable" class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td id="totalCostPrice">0</td>
                                        <td id="totalCostQuantityPrice">0</td>
                                        <td id="totalSellingPrice">0</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
...
<script>
    ...
    async function getList(startDate = '', endDate = '') {
        try {
            ...
            ProductData = ProductData.filter(item => item.quantity == 0);

            // If there are no out-of-stock products
            if (ProductData.length === 0) {
                tableList.append('<tr><td colspan="9" class="text-center">No Out-of-Stock Products Found</td></tr>');
            }
            ...
            ProductData.forEach(function(item, index) {
                ...
                let row = `
                    <tr>
                        ...
                        <td>
                            <img style="width: 60px; height: auto" alt="${item.product_name}" src="${img_url}">
                        </td>
            ...
            $("#totalSellingPrice").text(totalSellingPrice);
            $("#totalQuantity").text(totalQuantity);
            $("#totalCostQuantityPrice").text(totalCostQuantityPrice); // Update total for Cost Price * Quantity
    ...
    // Helper function to format product codes
