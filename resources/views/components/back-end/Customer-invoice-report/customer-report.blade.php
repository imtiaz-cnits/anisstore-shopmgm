    ...
    fetchReportButton.addEventListener("click", async function () {
        ...
        try {
            ...
            if (data.status === "success") {
                ...
                if (orders.length === 0) {
                    reportTableBody.innerHTML = `<tr><td colspan="8" class="text-center">No orders found for this customer.</td></tr>`;
                    return;
                }
                ...
                reportTableBody.innerHTML = `<tr><td colspan="8" class="text-center">No data found.</td></tr>`;
            }
        } catch (error) {
