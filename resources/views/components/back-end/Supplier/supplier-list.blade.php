                ...
                <div class="card">
                    <div class="card-body">
                        <div class="button-wrapper mb-3">
                            ...
                            <div class="button-item d-flex align-items-center gap-2">
                                <button id="openSupplierModalBtn" type="button" class="btn btn-success fw-bold create-invoice create-supplier-btn d-inline-flex align-items-center gap-1 shadow-sm px-3 py-2" onclick="openSupplierCreateModal()" style="border-radius: 8px; font-size: 13px; background: #15803d; border: none; color: #ffffff;">
                                    <i class="fa-solid fa-plus fs-6 me-1"></i> Create Supplier
                                </button>
                            ...
                            <table id="printTable" class="table table-bordered table-hover align-middle">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-start" style="width: 120px;">Supplier ID</th>
                ...
                pageItems.forEach(function (item, idx) {
                    ...
                    let row = `
                        <tr data-row="${realIndex + 1}">
                            ...
                            <td>
                                <a href="/supplier/profile/${item['id']}" class="fw-bold text-success text-decoration-none">
