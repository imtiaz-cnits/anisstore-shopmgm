                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-row mb-2">
                            ...
                            <input type="tel" inputmode="tel" maxlength="15" placeholder="০১৭xxxxxxxx" id="UpdatesupplierMobile" class="form-control fw-bold" style="height: 44px; border-radius: 10px; font-size: 14px; border: 1.5px solid #cbd5e1; background: #ffffff;" oninput="enforceBanglaNumberInput(this)" required />
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-row mb-2">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-row mb-2">
                            ...
                            <input type="text" inputmode="decimal" placeholder="৳ ০.০০" id="UpdatePurchasePayableAmount" class="form-control fw-bold" style="height: 44px; border-radius: 10px; font-size: 14px; border: 1.5px solid #cbd5e1; background: #ffffff;" oninput="enforceBanglaNumberInput(this)" />
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-row mb-2">
