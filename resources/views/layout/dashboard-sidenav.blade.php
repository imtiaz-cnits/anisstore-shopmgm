  ...
  <nav id="page-topbar" class="isvertical-topbar">
    <div class="navbar-header">
      <div class="d-flex align-items-center">
        ...
        <a href="{{ url('admin-dashboard') }}" class="d-flex align-items-center ms-1 text-decoration-none py-1">
      ...
      <div class="d-flex align-items-center gap-2">
        <!-- Ultra-Sleek Home Button Pill Badge in marked position -->
        <a href="{{ url('admin-dashboard') }}" class="btn btn-sm btn-outline-success fw-bold d-inline-flex align-items-center gap-1.5 px-2.5 py-1 shadow-sm rounded-pill me-1" style="background: #f0fdf4; border-color: #86efac; color: #15803d; height: 32px; font-size: 12px; transition: all 0.2s ease;" title="ড্যাশবোর্ডে ফিরে যান">
          <i class="fa-solid fa-house text-success fs-6"></i>
          <span class="d-none d-sm-inline fw-bold" style="font-family: 'Noto Sans Bengali', sans-serif;">হোম</span>
        </a>
        ...
        <div class="dropdown d-inline-block position-relative">
          ...
          <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 page-header-notifications-dropdown-v shadow-lg border-0"
            aria-labelledby="page-header-notifications-dropdown-v" style="width: 340px; max-width: 90vw; border-radius: 12px;">
        ...
        <div class="nav">
          <div class="menu">
            <ul>
              ...
              <li class="active-link" data-perm="expense">
...
<script>
  ...
  <script>
    ...
    document.addEventListener('input', function(e) {
        ...
        // Check if field requires numeric-only input
        ...
        if (isNumericOnly) {
            // Strict filtering: Allow both English & Bangla digits and optional decimal point (.)
