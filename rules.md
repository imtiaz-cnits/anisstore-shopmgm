...
- **কার্ড বর্ডার ও শেপ:** প্রতিটি কার্ডে নির্ধারিত সফট কালার বর্ডার থাকবে (মোট পাওনা: `#ffa39e`, মোট দেনা: `#91caff`, পণ্য: `#87e8de`, পার্টি: `#ffe58f`)।
- **স্কুপড নচ (Scooped Notch):** কার্ডের টপ-লেফটে সার্কুলার আইকন ব্যাজের নিচে কার্ডের বর্ডার লাইনটি আর্কের মতো নিচে নেমে একটি স্কুপড খাঁজ (concave scoop/cutout) তৈরি করবে।
- **আইকন ব্যাজ:** ৩৮×৩৮px সার্কুলার ব্যাজ, ভাইব্রেন্ট গ্রেডিয়েন্ট ব্যাকগ্রাউন্ড, ভেতরে পরিষ্কার সাদা আইকন (`color: #ffffff;`)।
- **রাইট অ্যারো:** কার্ডের ভ্যালুর সাথে ডানে রয়্যাল পার্পল বাটন অ্যারো (`fa-solid fa-arrow-right`) থাকবে।

### 8.2 Secondary Detailed List Cards (সেকেন্ডারি ডিটেইল্ড লিস্ট কার্ড)
- **আইকন ব্যাজ শেপ:** সার্কেলের পরিবর্তে আধুনিক সফট স্কয়ার শেপ (`border-radius: 12px; width: 44px; height: 44px;`) হবে।
- **রং বিন্যাস:**
...
### 8.3 Dashboard Tables Mobile & Tablet Box Type (ড্যাশবোর্ড টেবিল বক্স টাইপ রেসপনসিভ)
...
- **কার্ড ডিজাইন:** রাউন্ডেড-৪ কার্ড, সফট বর্ডার, অর্ডার নং/কোড ব্যাজ, বোল্ড অ্যামাউন্ট/স্টক এবং স্পেসিফিক অ্যাকশন বাটন সহ।
